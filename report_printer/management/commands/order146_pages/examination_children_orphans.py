...
class ExamChildrenDifficultSituationPrimaryPage(MedicalServiceTypePage):
    """
    Лист принятых услуг по диспансеризации детей-сирот, попавших в трудную
    жизненную ситуацию (приёмы врачей терапевтов)
    """
...
class ExamChildrenDifficultSituationSpecPage(MedicalServiceTypePage):
    """
    Лист принятых услуг по диспансеризации детей-сирот, попавших в трудную
    жизненную ситуацию (приёмы врачей-специалистов)
    """
...
class ExamChildrenWithoutCarePrimaryPage(MedicalServiceTypePage):
    """
    Лист принятых услуг по диспансеризации детей-сирот, оставшихся без попечения
