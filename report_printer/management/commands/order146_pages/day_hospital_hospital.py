...
class InvasiveMethodsPage(MedicalServiceTypePage):
    """
    Лист принятых услуг по инвазивные методы по гинекологии.
...
class InvasiveMethodsAllPage(InvasiveMethodsPage):
    def get_output_order_fields(self):
        fields = ('count_patients',
                  'count_patients_adult',
                  'count_patients_child',
...
class InvasiveMethodsInPartPage(InvasiveMethodsPage):
    def get_output_order_fields(self):
        fields = ('count_patients',
                  'count_patients_adult',
                  'count_patients_child',
...
class DayHospitalMedRehabilitationPage(MedicalServiceTypePage):
    """
    Лист принятых услуг по медицинской реабилитации в дневном стационаре
    """
