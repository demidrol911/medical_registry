...
class PeriodicMedicalExamPage(MedicalServiceTypePage):
    """
    Лист принятых услуг по периодическим медосмотрам несовершеннолетних
    """
    ...
    def get_output_order_fields(self):
        return ('119151', 2, ('count_patients',
                              'count_services',
                              'total_tariff',
                              'coeff1_07',
                              'total_accepted')),
...
class PrelimMedicalExamPrimaryPage(MedicalServiceTypePage):
    """
    Лист принятых услуг по предварительным медосмотрам несовершеннолетних
    (приёмы врачей терапевтов)
    """
...
class PrelimMedicalExamSpecPage(MedicalServiceTypePage):
    ...
    def get_output_order_fields(self):
        return ('0', 23, ('count_patients', 'count_services')),


class PreventMedicalExamPrimaryPage(MedicalServiceTypePage):
    """
    Лист принятых услуг по профилактическим медосмотрам несовершеннолетних
    (приёмы врачей терапевтов)
    """
