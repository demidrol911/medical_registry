...
class Order146Page(ReportPage):
    ...
    def print_page(self, sheet, parameters):
        ...
        data_keys = ('men1', 'fem1', 'men2', 'fem2', 'men3', 'fem3', 'men4', 'fem4', 'men5', 'fem5')
        if policlinic_capitation[0]:
            sheet.set_position(31, 15)
            for data_key in data_keys:
                if data_key in ('men1', 'fem1', 'men2', 'fem2', 'men3', 'fem3'):
                    adult = 0
                    child = policlinic_capitation[1][data_key]['accepted']
                else:
                    adult = policlinic_capitation[1][data_key]['accepted']
                    child = 0
                ...
                sheet.write(adult, 'c')
                sheet.write(child, 'c')
                sheet.set_position(sheet.get_row_index() + 1, 15)

        if ambulance_capitation[0]:
            sheet.set_position(42, 15)
            for data_key in data_keys:
                if data_key in ('men1', 'fem1', 'men2', 'fem2', 'men3', 'fem3'):
                    adult = 0
                    child = ambulance_capitation[1][data_key]['accepted']
                else:
                    adult = ambulance_capitation[1][data_key]['accepted']
                    child = 0
