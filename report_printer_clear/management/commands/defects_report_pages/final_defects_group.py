...
class FinalDefectsGroupPage(ReportPage):
    ...
    def _get_region(self, mo_code):
        print mo_code
        for region in FinalDefectsGroupPage.DEFECTS_AREA_GROUP:
            if mo_code in FinalDefectsGroupPage.DEFECTS_AREA_GROUP[region]['mo']:
                return region
        return None
    ...
    def calculate(self, parameters):
        ...
        for file_from_dir in os.listdir(path_to_dir):
            ...
            if filename_match:
                ...
                region = self._get_region(mo_code)
                if not region:
