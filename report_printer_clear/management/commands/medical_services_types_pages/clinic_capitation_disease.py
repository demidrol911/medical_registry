...
class ClinicCapitationDiseaseTreatmentPrimary(MedicalServiceTypePage):
...
class ClinicCapitationDiseaseSingleVisitSpec(MedicalServiceTypePage):
...
class ClinicCapitationDiseaseSingleVisitAll(MedicalServiceTypePage):
