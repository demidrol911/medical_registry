...
class ClinicCapitationAllPrimary(MedicalServiceTypePage):
...
class ClinicCapitationAllSpec(MedicalServiceTypePage):
...
class ClinicCapitationAll(MedicalServiceTypePage):
